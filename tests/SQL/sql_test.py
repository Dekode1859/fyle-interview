...
def test_get_assignments_in_various_states():
    ...
    expected_result = [('DRAFT', 2), ('GRADED', 1)]
    ...
    expected_result = [('DRAFT', 1), ('GRADED', 2)]

    # Find an assignment in the 'SUBMITTED' state, change its state to 'GRADED' and grade to 'C'
    submitted_assignment: Assignment = Assignment.filter(Assignment.state == AssignmentStateEnum.DRAFT).first()
