...
def submit_assignment(p, incoming_payload):
    ...
    asubmitted_assignment = Assignment.submit(
        submit_assignment_payload.id, submit_assignment_payload.teacher_id, p
    )
    db.session.commit()
    submitted_assignment_dump = AssignmentSchema().dump(asubmitted_assignment)
